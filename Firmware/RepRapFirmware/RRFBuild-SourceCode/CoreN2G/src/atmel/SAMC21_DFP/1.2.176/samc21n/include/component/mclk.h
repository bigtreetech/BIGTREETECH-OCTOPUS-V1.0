...
#define MCLK_AHBMASK_RESETVALUE     _U_(0x00003CFF) /**< \brief (MCLK_AHBMASK reset_value) AHB Mask */
...
#define MCLK_AHBMASK_MASK           _U_(0x00003FFF) /**< \brief (MCLK_AHBMASK) MASK Register */
...
#define MCLK_APBDMASK_TC5           (_U_(0x1) << MCLK_APBDMASK_TC5_Pos)
...
#define MCLK_APBDMASK_MASK          _U_(0x0000001F) /**< \brief (MCLK_APBDMASK) MASK Register */
