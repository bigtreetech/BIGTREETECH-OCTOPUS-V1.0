...
#define PAC_INTFLAGAHB_MASK         _U_(0x000001FF) /**< \brief (PAC_INTFLAGAHB) MASK Register */
...
#define PAC_INTFLAGD_TC5            (_U_(0x1) << PAC_INTFLAGD_TC5_Pos)
...
#define PAC_INTFLAGD_MASK           _U_(0x0000001F) /**< \brief (PAC_INTFLAGD) MASK Register */
...
#define PAC_STATUSD_TC5             (_U_(0x1) << PAC_STATUSD_TC5_Pos)
...
#define PAC_STATUSD_MASK            _U_(0x0000001F) /**< \brief (PAC_STATUSD) MASK Register */
