...
#define REG_PORT_PMUX2             (*(RwReg8 *)0x41000130UL) /**< \brief (PORT) Peripheral Multiplexing 2 */
#define REG_PORT_PINCFG2           (*(RwReg8 *)0x41000140UL) /**< \brief (PORT) Pin Configuration 2 */
