...
#define SUPC_INTENCLR_VREG33RDY     (_U_(0x1) << SUPC_INTENCLR_VREG33RDY_Pos)
#define SUPC_INTENCLR_MASK          _U_(0x0000007F) /**< \brief (SUPC_INTENCLR) MASK Register */
...
#define SUPC_INTENSET_VREG33RDY     (_U_(0x1) << SUPC_INTENSET_VREG33RDY_Pos)
#define SUPC_INTENSET_MASK          _U_(0x0000007F) /**< \brief (SUPC_INTENSET) MASK Register */
...
#define SUPC_INTFLAG_VREG33RDY      (_U_(0x1) << SUPC_INTFLAG_VREG33RDY_Pos)
#define SUPC_INTFLAG_MASK           _U_(0x0000007F) /**< \brief (SUPC_INTFLAG) MASK Register */
...
#define SUPC_STATUS_VREG33RDY       (_U_(0x1) << SUPC_STATUS_VREG33RDY_Pos)
#define SUPC_STATUS_MASK            _U_(0x0000007F) /**< \brief (SUPC_STATUS) MASK Register */
...
#define SUPC_VREG33_RESETVALUE      _U_(0x00000010) /**< \brief (SUPC_VREG33 reset_value) VREG33 Control */

#define SUPC_VREG33_ENABLE_Pos      1            /**< \brief (SUPC_VREG33) VREG33 Enable */
#define SUPC_VREG33_ENABLE          (_U_(0x1) << SUPC_VREG33_ENABLE_Pos)
#define SUPC_VREG33_ENRDY_Pos       2            /**< \brief (SUPC_VREG33) VREG33 Ready Enable */
#define SUPC_VREG33_ENRDY           (_U_(0x1) << SUPC_VREG33_ENRDY_Pos)
#define SUPC_VREG33_BYPASS_Pos      3            /**< \brief (SUPC_VREG33) VREG33 Bypass */
#define SUPC_VREG33_BYPASS          (_U_(0x1) << SUPC_VREG33_BYPASS_Pos)
#define SUPC_VREG33_ISOEN_Pos       4            /**< \brief (SUPC_VREG33) Isolation Enable */
#define SUPC_VREG33_ISOEN           (_U_(0x1) << SUPC_VREG33_ISOEN_Pos)
#define SUPC_VREG33_MASK            _U_(0x0000001E) /**< \brief (SUPC_VREG33) MASK Register */
