...
#pragma weak INT9_Handler             = Dummy_Handler /* SERCOM0, SERCOM6 */
#pragma weak INT10_Handler            = Dummy_Handler /* SERCOM1, SERCOM7 */
...
#endif
#pragma weak INT20_Handler            = Dummy_Handler /* TC0, TC5 */
#pragma weak INT21_Handler            = Dummy_Handler /* TC1, TC6 */
#pragma weak INT22_Handler            = Dummy_Handler /* TC2, TC7 */
...
const DeviceVectors __vector_table[] = {
        ...
        (void*) INT9_Handler,           /*  9 Serial Communication Interface 0, Serial Communication Interface 6 */
...
#endif
        (void*) INT20_Handler,          /* 20 Basic Timer Counter 0, Basic Timer Counter 5 */
        (void*) INT21_Handler,          /* 21 Basic Timer Counter 1, Basic Timer Counter 6 */
        (void*) INT22_Handler,          /* 22 Basic Timer Counter 2, Basic Timer Counter 7 */
